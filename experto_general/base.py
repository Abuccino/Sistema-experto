...
class BaseConocimientos:
    ...
    def get_or_add_entry(self, name: str) -> Entry:
        ...
        :param name: El nombre de la entrada
    ...
    def to_dict(self):
        """
        Convierte la base de conocimientos en un diccionario para su uso en otros contextos
        :return: Un diccionario que representa la base de conocimientos
        """
        return {
